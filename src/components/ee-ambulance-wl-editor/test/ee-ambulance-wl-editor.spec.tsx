...
import { EeAmbulanceWlEditor } from '../ee-ambulance-wl-editor';
  ...
  },
  {
    ...
    components: [EeAmbulanceWlEditor],
    html: `<ee-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></ee-ambulance-wl-editor>`,
    });
